...
Integrate planning, scheduling, and execution into end-to-end run lifecycle.
...
- docs/contracts/STATE_MACHINES.md; docs/contracts/EVENT_MODEL.md
- `AGENTS.md`
...
Primary modules:
- src/RavenMcp.Planning; src/RavenMcp.Execution; src/RavenMcp.Core
...
- one real run completes through lifecycle
