...
Implement preflight readiness, capability checks, and deterministic skip prediction.
...
- docs/contracts/DOMAIN_MODEL.md; docs/contracts/ERROR_TAXONOMY.md
- `AGENTS.md`
...
Primary modules:
- src/RavenMcp.Planning; src/RavenMcp.Core
