...
Implement structured selector normalization and expert-filter wrapper behavior.
...
- docs/contracts/DOMAIN_MODEL.md; docs/contracts/MCP_TOOLS.md
- `AGENTS.md`
