...
Implement attempt persistence, state transitions, and attempt event publication.
...
- docs/contracts/STATE_MACHINES.md; docs/contracts/STORAGE_MODEL.md
- `AGENTS.md`
...
Primary modules:
- src/RavenMcp.Flaky; src/RavenMcp.Storage.RavenEmbedded
...
- attempt persistence tests pass
