...
Implement flaky history, stability report, MCP surfaces, and UI model integration.
...
- docs/contracts/FRONTEND_VIEW_MODELS.md; docs/contracts/MCP_TOOLS.md
- `AGENTS.md`
...
Primary modules:
- src/RavenMcp.Flaky; src/RavenMcp.Web.Api; src/RavenMcp.Web.Ui
