...
Implement live console, cursor consumption, and results explorer.
...
- docs/contracts/FRONTEND_VIEW_MODELS.md; docs/contracts/EVENT_MODEL.md
- `AGENTS.md`
