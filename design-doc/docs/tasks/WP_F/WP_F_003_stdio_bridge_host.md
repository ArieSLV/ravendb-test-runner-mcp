...
Implement the stdio compatibility host with strict stdout hygiene.
...
- docs/contracts/MCP_TOOLS.md; docs/contracts/SECURITY_AND_REDACTION.md
- `AGENTS.md`
