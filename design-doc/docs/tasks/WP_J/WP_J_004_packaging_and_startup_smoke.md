...
Implement packaging scripts and cold-start smoke validation for the stand-alone app.
...
Primary modules:
- packaging/; tests/RavenMcp.IntegrationTests
...
- package starts locally with documented prerequisites
