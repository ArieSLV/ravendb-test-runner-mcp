...
Implement SignalR hub and mapping from internal events to browser events.
...
- docs/contracts/EVENT_MODEL.md; docs/contracts/WEB_API.md
- `AGENTS.md`
...
- live hub integration tests pass
