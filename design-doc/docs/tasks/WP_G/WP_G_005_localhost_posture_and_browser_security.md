...
Implement localhost-only defaults, trusted-local auth baseline, and browser security headers as applicable.
...
- docs/contracts/SECURITY_AND_REDACTION.md; docs/contracts/WEB_API.md
- `AGENTS.md`
...
- binding and local-security tests pass
