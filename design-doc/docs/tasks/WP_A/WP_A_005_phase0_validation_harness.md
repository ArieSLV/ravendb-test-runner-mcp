...
Create contract test harness and document-validation checks used by later work packages.
...
Primary modules:
- tests/RavenMcp.ContractTests; tests/RavenMcp.UnitTests
...
- phase-0 validation suite runs cleanly
