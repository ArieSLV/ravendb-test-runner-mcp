...
Implement document ID helpers, naming constants, and collection name constants.
...
Primary modules:
- src/RavenMcp.Storage.RavenEmbedded; src/RavenMcp.Core.Abstractions
...
- ID format tests pass; collection names centralized
