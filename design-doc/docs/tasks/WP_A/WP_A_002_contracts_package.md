...
Create the shared contracts package and initial DTO/type definitions aligned with frozen contracts.
...
- docs/contracts/DOMAIN_MODEL.md; docs/contracts/STATE_MACHINES.md
- `AGENTS.md`
...
Primary modules:
- src/RavenMcp.Shared.Contracts; src/RavenMcp.Domain
...
- contract types compile; serialization tests pass
