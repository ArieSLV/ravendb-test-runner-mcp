...
- Carry forward to `WP_A_006`: `WP_A_003` introduced exhaustive implementation-facing ID patterns for all 20 persisted document families, while `STORAGE_MODEL.md` currently lists example ID patterns for 12 families.
