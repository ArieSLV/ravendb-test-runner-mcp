...
Create the solution, project folders, Directory.Build props, and placeholder project references.
...
Primary modules:
- src/RavenMcp.Core.Abstractions; src/RavenMcp.Domain; src/RavenMcp.Shared.Contracts; solution file
...
- solution loads; projects restore; naming matches execution pack
