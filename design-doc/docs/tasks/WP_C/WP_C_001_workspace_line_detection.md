...
Implement workspace fingerprinting and repo line detection for v6.2/v7.1/v7.2.
...
Primary modules:
- src/RavenMcp.Core; src/RavenMcp.Semantics.Abstractions
