...
Implement `RavenV72Semantics`, category/requirement extraction, and catalog persistence.
...
- docs/contracts/VERSIONING_AND_CAPABILITIES.md; docs/contracts/DOMAIN_MODEL.md
- `AGENTS.md`
...
Primary modules:
- src/RavenMcp.Semantics.Raven.V72; src/RavenMcp.Storage.RavenEmbedded
...
- v7.2 catalog stored; capability matrix generated
