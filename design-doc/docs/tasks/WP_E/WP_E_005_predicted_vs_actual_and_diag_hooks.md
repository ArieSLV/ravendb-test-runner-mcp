...
Implement predicted-vs-actual reconciliation and diagnostics escalation metadata hooks.
...
- docs/contracts/EVENT_MODEL.md; docs/contracts/ERROR_TAXONOMY.md
- `AGENTS.md`
...
Primary modules:
- src/RavenMcp.Results; src/RavenMcp.Execution
