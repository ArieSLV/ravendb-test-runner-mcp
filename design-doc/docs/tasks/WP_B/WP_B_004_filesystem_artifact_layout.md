...
Implement canonical filesystem layout manager and path normalization.
...
- docs/contracts/ARTIFACTS_AND_RETENTION.md; docs/contracts/SECURITY_AND_REDACTION.md
- `AGENTS.md`
...
- filesystem paths deterministic and safe
